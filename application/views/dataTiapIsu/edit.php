                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body pt-0 pb-2">
                            <div class="row pl-2">
                                <form method="post" action="<?= site_url('DataIsu/edit/' . $detail[0]->id) ?>" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="judul" id="judul" class="form-control" type="text" placeholder="Masukkan judul isu ..." value="<?= $detail[0]->judul ?>">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="isu" id="isu" class="form-control" type="search" placeholder="Masukkan isu ..." value="<?= $detail[0]->isu ?>">
