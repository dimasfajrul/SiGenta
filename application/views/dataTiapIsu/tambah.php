                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="judul" id="judul" class="form-control" type="text" placeholder="Masukkan judul isu ..." id="example-text-input">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="isu" id="isu" class="form-control" type="search" placeholder="Masukkan isu ..." id="example-search-input">
