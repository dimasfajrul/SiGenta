                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="nama" id="nama" class="form-control" type="text" placeholder="Masukkan tanggal masuk ..." id="example-text-input">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="nohp" id="nohp" class="form-control" type="search" placeholder="Masukkan asal surat ..." id="example-search-input">
