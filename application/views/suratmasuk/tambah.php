                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body pt-0 pb-2">
                            <div class="row pl-2">
                                <form method="post" action="<?= site_url('SuratMasuk/tambah') ?>" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Tanggal Masuk</label>
                                                <input name="tanggal" id="tanggal" class="form-control" type="date" placeholder="Masukkan tanggal masuk ..." id="example-text-input">
                                                <?= form_error('tanggal', '<small style="padding-left: 0; margin-left: 0;" class="text-danger">', '</small>'); ?>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="example-search-input" class="form-control-label">Asal Surat</label>
                                                <input name="asal" id="asal" class="form-control" type="search" placeholder="Masukkan asal surat ..." id="example-search-input">
