                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="judul" id="judul" class="form-control" type="text" placeholder="Masukkan judul berkas ...">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="ro" id="ro" class="form-control" type="search" placeholder="Masukkan RO ..." id="example-search-input">
