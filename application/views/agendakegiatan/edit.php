                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="judul" id="judul" class="form-control" type="text" placeholder="Masukkan judul berkas ..." value="<?= $detail[0]->agendakegiatan ?>">
                                                <?= form_error('judul', '<small style="padding-left: 0; margin-left: 0;" class="text-danger">', '</small>'); ?>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="example-search-input" class="form-control-label">Waktu Kegiatan</label>
